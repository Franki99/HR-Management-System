...
public class LandingPage extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        Start.setBackground(new java.awt.Color(0, 51, 51));
        Start.setFont(new java.awt.Font("Tahoma", 1, 24)); // NOI18N
        Start.setForeground(new java.awt.Color(255, 255, 255));
        Start.setText("Start");
        Start.setPreferredSize(new java.awt.Dimension(75, 39));
        ...
        jLabel1.setText("Welcome To SHR Tool");

        jLabel2.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(255, 255, 255));
        jLabel2.setText("We provide Smart HR(Human Resource) ");

        jLabel3.setFont(new java.awt.Font("Arial Black", 1, 26)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(255, 255, 255));
        jLabel3.setText("Step in the digital World");

        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/org/view/rename.jpg"))); // NOI18N
        jLabel4.setText("jLabel4");
        jLabel4.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(255, 255, 255), 5));

        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/org/view/new.jpg"))); // NOI18N
        jLabel5.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(255, 255, 255), 5));

        jLabel6.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel6.setForeground(new java.awt.Color(255, 255, 255));
        jLabel6.setText("Managment Solutions icluding digtal Record keeping");
